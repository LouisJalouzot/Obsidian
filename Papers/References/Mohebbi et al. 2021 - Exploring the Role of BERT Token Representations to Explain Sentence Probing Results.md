...
[TLDR] It is shown that BERT tends to encode meaningful knowledge in specific token representations, allowing the model to detect syntactic and semantic abnormalities, and to distinctively separate grammatical number and tense subspaces.
